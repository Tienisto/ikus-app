...
class FAQService {
  ...
  static List<Post> _posts = [
    Post("Bis wann kann ich immatrikulieren?", "Prof. Dr.-Ing. Jens Strackeljan wurde als Rektor der Otto-von-Guericke-Universität Magdeburg im Amt wiedergewählt. Am 15. Juli 2020 hat der erweiterte Senat, das höchste Gremium der Universität,", _loremIpsum, "Allgemeines", DateTime(2020, 7, 15), []),
